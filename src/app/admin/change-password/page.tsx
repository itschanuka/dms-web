...
export default function ChangePasswordPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (result.success) {
      // After password change, need to go set up MFA
    ...
    <div className="auth-page">
      <div className="auth-card">
        <div style={{ marginBottom: 28 }}>
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#f59e0b', marginBottom: 8 }}>
            Action required
          </div>
