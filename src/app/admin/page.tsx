...
export default function AdminDashboard() {
  ...
  // Guard: redirect if password change still required
  useEffect(() => {
    if (!isLoading && employee?.must_change_password) {
    ...
    <div style={{ minHeight: '100vh', background: '#07090f', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <main style={{ padding: '48px 32px', maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#5c7090', marginBottom: 16 }}>
            Your account
          </div>
