    ...
    <>
      ...
      >
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          ...
          >
            Discover carefully inspected vehicles, transparent pricing,
            and a dealership built on trust and long-term relationships.
          </p>
          ...
          {[
            {
              ...
              desc: 'Hand-selected used and brand new vehicles meeting strict inspection standards.',
            },
            {
              icon: '💰',
              title: 'Fair Pricing',
              desc: 'Transparent pricing with no hidden fees and clear documentation.',
            },
            {
              icon: '🏦',
              title: 'Flexible Financing',
              desc: 'Multiple finance options tailored to suit your budget and needs.',
            },
            {
              icon: '🛡️',
              title: 'After-Sales Support',
              desc: 'We stand behind every vehicle we sell with reliable customer support.',
            },
          ].map((item) => (
            <div
              key={item.title}
            ...
            >
              ...
              <p style={{ fontSize: 14, color: '#5c7090', margin: 0, lineHeight: 1.6 }}>
                {item.desc}
              </p>
            </div>
          ))}
